...
// Inject GA script dynamically and return a Promise that resolves when ready
const loadGAScript = () => {
  return new Promise((resolve) => {
    ...
    script.onerror = resolve; // Resolve anyway so we don't block on ad-blocker
...
export const trackPageView = (page_title, page_location) => {
  ...
  if (_lastPageView && currentTime - _lastPageView.time < 1000 &&
...
// Track the current page — convenience helper for post-consent and on-load scenarios
